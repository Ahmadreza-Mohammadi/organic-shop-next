  ...
  return (
    <>
      ...
      <div className="bg-[#1A1A1A] text-white w-full p-8 flex flex-wrap justify-around">
        <div className="w-full md:w-1/5 flex flex-col justify-between mb-5">
          <h1 className="font-bold text-2xl clear-start text-green-500">ارگانیک شاپ</h1>
          <p className="text-lg">
            ما به شما محصولات ارگانیک با بهترین کیفیت و خدمات عرضه می‌کنیم که با
            دقت و توجه انتخاب شده‌اند.
          </p>
          <span className="border-b-2 border-green-600 w-28">۸۸۷۷۸۸۹۸ - ۰۲۱</span>
        </div>
        <div className="w-full md:w-1/5 flex flex-col gap-14 mb-5">
          <h2 className="font-bold text-xl text-green-500">لینک‌های مفید</h2>
        ...
        <div className="w-full md:w-1/5 flex flex-col gap-14 mb-5">
          <h2 className="font-bold text-xl text-green-500">دسته‌بندی‌ها</h2>
          <ul className="flex flex-col gap-3">
        ...
        <div className="w-full md:w-1/5 flex flex-col gap-14 mb-5">
          <h2 className="font-bold text-xl text-green-500">اخبار و رویدادها</h2>
          <ul className="flex flex-col gap-3">
